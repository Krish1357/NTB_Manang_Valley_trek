...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [9288318.985720, 3254339.578070, 9422330.558195, 3393710.469698], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([9288318.985720, 3254339.578070, 9422330.558195, 3393710.469698], map.getSize());
